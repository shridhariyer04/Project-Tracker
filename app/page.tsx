      ...
      <section className="pt-40 pb-24 px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <SignInButton mode="modal">
            <button className="group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-2xl font-medium transition-all duration-300 inline-flex items-center space-x-3 hover:scale-105 shadow-lg hover:shadow-xl">
